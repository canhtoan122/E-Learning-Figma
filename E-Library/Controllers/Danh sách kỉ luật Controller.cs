...
namespace E_Library.Controllers
{
    ...
    [ApiController]
    public class Danh_sách_kỉ_luật_Controller : ControllerBase
    {
        ...
        public Danh_sách_kỉ_luật_Controller(DataContext context)
        {
            _context = context;
        }

        [HttpGet]
        public async Task<ActionResult<List<Danh_sách_kỉ_luật>>> Get()
        {
            return Ok(await _context.Danh_sách_kỉ_luật.ToListAsync());
        }
        [HttpGet("{Mã Học Viên}")]
        public async Task<ActionResult<List<Danh_sách_kỉ_luật>>> Get_Mã_Học_Viên(Học_viên hoc_vien)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<List<Danh_sách_kỉ_luật>>> Add(Danh_sách_kỉ_luật ki_luat)
        {
            _context.Danh_sách_kỉ_luật.Add(ki_luat);
