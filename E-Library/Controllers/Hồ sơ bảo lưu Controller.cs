...
namespace E_Library.Controllers
{
    ...
    [ApiController]
    public class Hồ_sơ_bảo_lưu_Controller : ControllerBase
    {
        ...
        public Hồ_sơ_bảo_lưu_Controller(DataContext context)
        {
            _context = context;
        }

        [HttpGet]
        public async Task<ActionResult<List<Hồ_sơ_bảo_lưu>>> Get()
        {
            return Ok(await _context.Hồ_sơ_bảo_lưu.ToListAsync());
        }

        [HttpGet("Tìm Mã học viên")]
        public async Task<ActionResult<List<Hồ_sơ_bảo_lưu>>> Search_mã_học_viên(string name)
        {
            var result = await _context.Hồ_sơ_bảo_lưu.FindAsync(name);
            if (result == null)
        ...
        [HttpPost]
        public async Task<ActionResult<List<Hồ_sơ_bảo_lưu>>> Add(Hồ_sơ_bảo_lưu hoc_vien)
        {
            _context.Hồ_sơ_bảo_lưu.Add(hoc_vien);
